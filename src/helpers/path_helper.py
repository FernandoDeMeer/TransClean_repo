...
# TODO: Does the same as "with_subfolders" if only 1 arg is passed,
# refactor eventually
#
#
...
def update_results_path(results_path: str, subfolder_list: List[str]) -> str:
    return os.path.join(results_path, *subfolder_list)